...
def i():
    ...
    max = -result.fun
    arrivals, arrival_times = Poisson_no_homogeneo_adelgazamiento(1, max, lamda_t_1)
...
def ii():
    ...
    max = -result.fun
    arrivals, arrival_times = Poisson_no_homogeneo_adelgazamiento(1, max, lamda_t_2)
    print(f"Tiempo de llegada de los aficionados: {arrival_times}")
...
def iii():
    ...
    max = -result.fun
    arrivals, arrival_times = Poisson_no_homogeneo_adelgazamiento(1, max, lamda_t_3)
    print(f"Tiempo de llegada de los aficionados: {arrival_times}")
